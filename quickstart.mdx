...
<AccordionGroup>
  ...
  <Accordion title="Preview changes" icon="google">
...
<AccordionGroup>
  <Accordion title="Install our Github app" defaultOpen icon="paypal" iconType="brands">
  ...
  <Accordion title="Push your changes" icon="Apple">
...
<CardGroup cols={2}>
  <Card title="Add Content With MDX" href="/essentials/markdown" img="https://support.apple.com/content/dam/edam/applecare/images/en_US/psp/psp_heroes/mini-hero-applepay.png">
