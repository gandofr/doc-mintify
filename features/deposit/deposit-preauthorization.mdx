---
title: "En tant que client comment effectué une caution"
...
- `CB_VISA_MASTERCARD`seulement

Le flux de base de la fonction de préautorisation de 30 jours de Mangopay fonctionne comme suit :
